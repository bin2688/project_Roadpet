...
<body>
   ...
   <!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="PetStory_list" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>펫 스토리</a>
	...
	<div class="content">
		...
		<br>
		<textarea placeholder="댓글을 달아주세요" style="height: 200px; width: 95%;"></textarea>
		<button type="button" id="b1" class="btn btn-primary m-2">댓글달기</button><br>
		
		
		<button type="button" class="btn btn-primary m-2"
			onclick="location.href='PetStory_list'">글목록</button>
...
<%-- <div id="result">
	...
	<%
		for (ReplyVO vo : list) {
	%>-<%=vo.getReply_content()%>,<%=vo.getReply_id()%>
	<br>
	<%
		}
	%> --%>
