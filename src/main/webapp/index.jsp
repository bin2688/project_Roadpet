	...
	<div class="container-fluid position-relative bg-white d-flex p-0">
		...
		<div class="content open">
			...
			<div class="container-fluid pt-4 px-4">
				<h1 style="text-align: center;">RoadPet</h1>
				<br>
				...
				<div class="row g-4" style="width: 80%; margin: auto;">
					<div class="col-sm-6 col-xl-3">
						<div
							...
							<div class="ms-3" style="text-align: center;">
								<h4 class="mb-0">마이 펫</h4>
								<br>
								<h6 class="mb-0">반려동물을 등록하고 나의 펫 정보 보기,산책기록 등의 서비스를 이용할 수
									있어요.</h6>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-xl-3">
						<div
							...
							<div class="ms-3" style="text-align: center;">
								<h4 class="mb-0">펫 지도</h4>
								<br>
								<h6 class="mb-0">동물병원,보호소 위치정보를 제공하고 실종동물정보를 등록하고 공유할 수 있어요
									.</h6>
							</div>
			...
			<div class="container-fluid pt-4 px-4">
				<div class="row g-4" style="width: 80%; margin: auto;">
					<div class="bg-light text-center rounded p-4">
						...
						<div id="main_result3" style="text-align: left;"></div>
					</div>
				</div>
			</div>
